...
### Skills I know
- **Frontend**: HTML (pug), CSS (sass, tailwindcss), JS/TS (react, nextjs, vue and svelte)
- **Backend**: Python, C, Bash/Zsh, Firebase, Webbased API's
- **Tech**: Linux (I use Arch linux btw), Vim/Neovim, VS code
- **Misc**: Figma, Adobe XD, Zapier, Adobe Illustrator, GIMP, Krita, Inkscape
-----
